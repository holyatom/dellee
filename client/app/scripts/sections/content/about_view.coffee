    ...
    <Content className="p-about">
      ...
      <div className="p-a-top_section">
        <div className="container">
          ...
          <p><strong>Dellee</strong> - это сервис, с которым вы получаете возможность просто и удобно следить за всем новым и интересным в вашем городе. На Dellee вы можете найти и подписаться на любимые заведения и просматривать их новости. Более того, вы можете настроить sms или e-mail уведомления, чтобы оставаться в курсе последних новостей.</p>
          ...
          <div className="p-a-problems">
            <ul>
              ...
              <li>
                ...
                <main>С Dellee все новости собраны на вашей персональной странице, а e-mail или sms приходят <strong>одним письмом от одного адресанта Dellee</strong>. Сотрудники Dellee проверяют содержание новостей, поэтому можете быть уверенны, что НЕ будете получать неверную информацию и спам!</main>
              </li>
            </ul>
            <ul>
              <li>
              ...
              <li>
                <aside><i className="icon-emoji_smile"></i></aside>
                <main>C Dellee вы больше не тратите время на проверку страниц в соцсетях или веб-сайтов заведений и <strong>не пропускаете</strong> выгодные акции и предложения</main>
              </li>
            </ul>
            <ul>
              <li>
            ...
            <ul>
              <li>
                <aside><i className="icon-emoji_sad"></i></aside>
                <main>Не у всех заведений есть оповещения и иные способы связи с клиентами</main>
              </li>
              <li>
                <aside><i className="icon-emoji_smile"></i></aside>
                <main>Мы работаем над тем, чтобы на Dellee вы смогли найти <strong>все любимые заведения</strong></main>
              </li>
            </ul>
            <ul>
              <li>
              ...
              <li>
                <aside><i className="icon-emoji_smile"></i></aside>
                <main>Мы обеспечиваем вам <strong>приватность</strong>, компании не имеют доступа к какой-либо информации о пользователях Dellee. Также, благодаря этому вы всегда остаетесь <strong>на связи</strong> даже при изменении контактных данных</main>
              </li>
            </ul>
          </div>
        </div>
     ...
     <div className="p-a-bottom_section">
        <div className="container">
          ...
          <p>Мы всегда открыты для предложений по улучшению сервиса (<a href={"mailto:#{config.contacts.email}"}>{config.contacts.email}</a>), ведь наша приоритетная цель - это сделать ваше пользование сервисом Dellee наиболее комфортным и эффективным.</p>
